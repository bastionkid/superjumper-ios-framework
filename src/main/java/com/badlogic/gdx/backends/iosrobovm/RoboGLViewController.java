...
public class RoboGLViewController extends GLKViewController {
    final RoboApplication app;
    final RoboGraphics graphics;

    protected RoboGLViewController(RoboApplication app, RoboGraphics graphics) {
        this.app = app;
    ...
    public void viewWillAppear (boolean arg0) {
        ...
        app.debug("RoboGLViewController", "viewWillAppear()");
    ...
    private static boolean shouldAutorotateToInterfaceOrientation (RoboGLViewController self, Selector sel,
